...
>>>>>>> 9229af9... Implemented serialization of ColumnPartitionData and ColumnPartitionSchema. Added various tests. Added BlockManager tests that check serialization. Turned on JCuda exceptions when setting up SparkEnv.
